...
const TOOL_DEFINITIONS: ToolDefinition[] = [
	{
		...
		handler: api.assistant.tools.getMyCalendarToday,
	...
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getMyCalendarTomorrow,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getMyCalendarNextWeek,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getMyTasksToday,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getMyTasksTomorrow,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getMyTasksThisWeek,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getMyTasksNextWeek,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "getMyAllTasks",
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getMyAllTasks,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "searchTasks",
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.searchTasks,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.workspace.members.get,
	...
	},
	{
		...
		handler: api.assistant.conversations.savePendingTaskDraft,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "getRecentNotes",
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getRecentNotes,
		contextParams: { needsWorkspaceId: true },
	},
	{
		name: "searchNotes",
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.searchNotes,
		contextParams: { needsWorkspaceId: true },
	},
	{
		name: "searchChannels",
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.searchChannels,
		contextParams: { needsWorkspaceId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getChannelSummary,
		contextParams: { needsWorkspaceId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getChannelDebug,
		contextParams: { needsWorkspaceId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getWorkspaceOverview,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getWorkspaceGeneralSummary,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "getMyCards",
		...
		handlerType: "query" as const,
		handler: api.assistant.tools.getMyCards,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "semanticSearch",
		...
		handler: api.assistant.tools.semanticSearch,
		contextParams: { needsWorkspaceId: true },
	},
	{
		name: "runGmailTool",
		...
		handlerType: "action" as const,
		handler: api.assistant.composioTools.runGmailTool,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "runSlackTool",
		...
		handlerType: "action" as const,
		handler: api.assistant.composioTools.runSlackTool,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "runGithubTool",
		...
		handlerType: "action" as const,
		handler: api.assistant.composioTools.runGithubTool,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "runNotionTool",
		...
		handlerType: "action" as const,
		handler: api.assistant.composioTools.runNotionTool,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "runClickupTool",
		...
		handlerType: "action" as const,
		handler: api.assistant.composioTools.runClickupTool,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
	{
		name: "runLinearTool",
		...
		handlerType: "action" as const,
		handler: api.assistant.composioTools.runLinearTool,
		contextParams: { needsWorkspaceId: true, needsUserId: true },
	},
];
