...
const messageRoleValidator = v.union(v.literal("user"), v.literal("assistant"), v.literal("tool"));
/**
...
async function listMessages(ctx, conversationId, rawLimit) {
...
async function getLatestMessage(ctx, conversationId) {
    return await ctx.db
        .query("messages")
        .withIndex("by_conversation", (q) => q.eq("conversationId", conversationId))
        .order("desc")
