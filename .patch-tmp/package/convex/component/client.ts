...
import type { SchemaToolHandlers, TableInfo } from "./schemaTools";
import { generateToolsFromSchema } from "./schemaTools";
import type { AutoToolsConfig, DatabaseChatTool } from "./tools";
import { findTool, formatToolsForLLM, validateToolArgs } from "./tools";
...
export class DatabaseChatClient {
	 ...
	 * ```
	 */
	async getStreamDeltas(ctx: QueryCtx, streamId: string, cursor: number) {
