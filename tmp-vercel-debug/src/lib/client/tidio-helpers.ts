...
/**
 * Client-only Tidio chat helpers
 *
 * These functions mutate browser UI and must only be called from client components.
 * They have been separated from pure utilities to maintain clear boundaries.
 */
 ...
 * ```tsx
 * // Call from browser-only code
 * import { collapseTidioChat } from '@/lib/client/tidio-helpers';
 *
