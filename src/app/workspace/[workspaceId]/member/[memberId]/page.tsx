...
const MemberIdPage = () => {
	...
	// The title slot itself opens the member's profile panel, so it stays a
	// real interactive button rather than a plain heading. Memoized so the
	// title-slot registration doesn't re-fire (and re-render every consumer)
	// on every unrelated render of this page.
	...
	useSetWorkspaceTitle(memberTitle);
