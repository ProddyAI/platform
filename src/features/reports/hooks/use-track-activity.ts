...
export const useTrackActivity = ({
	...
	const recordActivity = useMutation(api.workspace.analytics.recordUserActivity);
	const recordChannelSession = useMutation(api.workspace.analytics.recordChannelSession);
