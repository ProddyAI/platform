...
Save the PRD as JSON in directory: /Users/macbook/Documents/GitHub/platform/.agents/tasks
...
User request:
an ai assitant based on the convex db, which can conect to external tools via composio
